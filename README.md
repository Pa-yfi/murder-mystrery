...
### مشخصات ظاهری، شهادت شاهد، و استعلام‌ها (rules.md R14)

هر شخصیت یک ظاهر ثابت دارد: قد، هیکل، مو، نشانه‌ی چهره و لباسِ آن شب.
ویژگی‌ها **عمداً** بین چند نفر مشترک‌اند — «بلندقامت با پالتو تیره» معمولاً
به سه چهار نفر می‌خورد. اگر به یک نفر می‌خورد، اولین شهادت بازی را تمام
می‌کرد.

- 👁️ **شهادت شاهد:** صبح‌ها، اگر کسی واقعاً شب بیرون رفته باشد، شاهدی یک یا
  دو ویژگی‌اش را می‌گوید — بدون نام، با تردیدِ صادقانه. پزشک و نگهبان هم
  بیرون می‌روند، پس شهادت یعنی «کسی بیرون بود»، نه «قاتل این است».
- 👤 **استعلام مشخصات (کارآگاه، روزی یک نفر):** مشخصات کاملِ یک نفر، به‌علاوه‌ی
  اینکه با کدام شهادتِ منتشرشده هم‌خوانی دارد. اکشن شبانه را خرج نمی‌کند.
- 🚗 **استعلام پلاک:** حالا هم بازجو و هم کارآگاه، هر کدام با سهمیه‌ی جدا،
  شبی یک بار. نتیجه سحر و فقط در پیوی.

### گفتگوی بازجویی و سرنخ پایانی (rules.md R07.2)

ربات «عرق کرد» یا «دستش لرزید» را **نمی‌بیند** و از خودش نمی‌سازد. سه منبعِ
مجاز:

- 🎭 **ژست شخصیت** — خودِ متهم انتخاب می‌کند (عصبی، آرام، شاکی از گرما،
  عصبانی) و بازجو آن را با برچسب «روایت صحنه» می‌بیند، نه مشاهده‌ی واقعی.
- 🗣️ **گفته‌های واقعی‌اش** — با ترتیب و شماره‌ی پاسخ.
- ⚖️ **درخواست وکیل** — فقط اگر واقعاً در متنش نوشته باشد، و صریح گفته
  می‌شود که حقِ دفاع است و نشانه‌ی گناه نیست.

هیچ نشانه‌ای از روی نقش یا تیم ساخته نمی‌شود.
