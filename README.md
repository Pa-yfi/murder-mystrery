...
هر ۶۹ فرمان را در هفت دسته نشان می‌دهد:
🎮 بازی · 🔦 بازجویی و دادگاه · 🔎 مدارک و دفترچه · 🏆 پیشرفت ·
⚙️ میز و میزبانی · 📚 راهنما · 🛠️ ادمین
...
| `/clear 4` | 🕊️ آزادی زندانی → فقط زندانی‌ها را نشان می‌دهد |
